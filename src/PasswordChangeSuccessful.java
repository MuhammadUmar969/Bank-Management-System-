public class PasswordChangeSuccessful extends javax.swing.JFrame {

    /**
     * Creates new form PasswordChangeSucessful
     */
    public PasswordChangeSuccessful() {
        initComponents();
    }
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("icons8-ok-200.png")); // NOI18N
        ...
        goBackLogin.setBackground(new java.awt.Color(21, 103, 153));
        ...
        goBackLogin.setIcon(new javax.swing.ImageIcon("icons8-back-arrow-30.png")); // NOI18N
    ...
    private void goBackLoginActionPerformed(java.awt.event.ActionEvent evt) {
        setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PasswordChangeSuccessful.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PasswordChangeSuccessful().setVisible(true);
            }
        });
    }

...
public class usernameAndPass extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon("icons8-circled-user-male-skin-type-1-2-100.png")); // NOI18N
        ...
        new CreateAccount();
        AccountNumber.setText(CreateAccount.accountnoforuandp);
        ...
        createAccountButton.setBackground(new java.awt.Color(21, 103, 153));
    ...
    private void createAccountButtonActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        if(PL && PC){
            ...
            try {
                ...
                new CreateAccount();
                String query = "INSERT INTO logindetails VALUES('"+ CreateAccount.accountnoforuandp +"','"+Username.getText()+"','"+Password.getText()+"','"+MailVerification.mail+"')";
    ...
    public boolean Passwordcheck(){
        ...
        else if("".equals(rePassword.getText())){
